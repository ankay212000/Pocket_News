                    ...
                    child: Align(
                      ...
                      child: Column(
                        children: <Widget>[
                          Text(
                            'WELCOME BACK !!!',
                            style: TextStyle(color: Colors.blueAccent, fontSize: 35.0,fontFamily: 'Shadows',fontWeight: FontWeight.bold),
                          ),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          child: Text(
                            "Register here!",
                            style: TextStyle(color: Colors.blueAccent,fontSize: 20,fontFamily: 'Shadows',fontWeight: FontWeight.bold),
                          ),
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
