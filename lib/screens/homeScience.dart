...
import 'package:pocketnews/CategoryUrl/science.dart';

class HomePageScience extends StatefulWidget {
  HomePageScience({
    this.category,
    Key key,
    this.controller,
  ...
  @override
  _HomePageScienceState createState() => _HomePageScienceState();
}

class _HomePageScienceState extends State<HomePageScience> {
  //String url = "https://newsapi.org/v2/top-headlines?country=in&category=&apiKey=ff94394ddcf74eb2be08755e5cd942e9";
  List<Post> posts = List();
  bool isLoaded = false;
  bool isBookmarked = false;
  String _url = kEnglishScienceURL;
  String _selectedLang = 'English';

  void languageSelect() {
    switch (_selectedLang) {
      case 'English':
        _url = kEnglishScienceURL;
        break;
      case 'Hindi':
        _url = kHindiScienceURL;
        break;
      case 'Malayalam':
        _url = kMalayalamScienceURL;
        break;
      case 'Marathi':
        _url = kMarathiScienceURL;
        break;
      case 'Tamil':
        _url = kTamilScienceURL;
        break;
      case 'Telugu':
        _url = kTeluguScienceURL;
        break;
    }
  }
